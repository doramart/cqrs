...
class EventBus extends Emiter{
    ...
    constructor(eventstore, repos ,actorListener) {
        ...
        this.es.useEventPublisher((evt, cb) => {
            ...
            this.actorListener.emit(evt.data.targetType + "." + evt.data.targetId + ":" + evt.name, event);

            this.emit(evt.data.targetType + "." + evt.data.targetId, event);
            this.actorListener.emit(evt.data.targetType + "." + evt.data.targetId, event);

            this.emit(evt.data.targetType + ":" + evt.name, event);
            this.actorListener.emit(evt.data.targetType + ":" + evt.name, event);

            this.emit("." + evt.data.targetId + ":" + evt.name, event);
            this.actorListener.emit("." + evt.data.targetId + ":" + evt.name, event);

            this.emit(":" + evt.name, event);
            this.actorListener.emit(":" + evt.name, event);

            this.emit(evt.data.targetType, event);
            this.actorListener.emit(evt.data.targetType, event);
            ...
            if (evt.contextId) {
                ...
                this.actorListener.emit(evt.data.targetType + "." + evt.data.targetId + ":" + evt.name + "&" + evt.contextId, event);
                this.actorListener.emit(evt.data.targetType + "." + evt.data.targetId + "&" + evt.contextId, event);
                this.actorListener.emit(evt.data.targetType + ":" + evt.name + "&" + evt.contextId, event);
                this.actorListener.emit("." + evt.data.targetId + ":" + evt.name + "&" + evt.contextId, event);
                this.actorListener.emit(":" + evt.name + "&" + evt.contextId, event);
                this.actorListener.emit(evt.data.targetType + "&" + evt.contextId, event);
