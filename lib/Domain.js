        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                if (Class.createBefor) {
                    ...
                    let serv = Object.create(this[service]);
                    ...
                    } else if (result && isGenerator.fn(result)) {
                ...
                } else if (Class.prototype.createBefor) {

                    let serv = Object.create(this[service]);
                    let createBefor = Class.prototype.createBefor;
                    if (isGenerator.fn(createBefor)) {

                    } else {
                        let result = createBefor(data, serv);
                        if (result && result instanceof Promise) {
                    ...
                    try {
                        ...
                        let call = ()=> {
                            if (isGenerator.fn(actor[method])) {
                                co(function *() {
                                    let result = yield actor[method](args, serv);
                                    callback(result);
                                    resolve(result);
                                }).catch(function (err) {
                                    reject(err);
                                ...
                                try {
                                    let result = actor[method](args, serv);
